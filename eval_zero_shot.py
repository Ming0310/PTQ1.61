...
from quantize.eval_register import omniquant
...
def main():
    ...
    # parser.add_argument("--net", type=str, default="llama-13b") # change here
    ...
    if args.wbits < 16 or args.abits <16:
        ...
        lm.model.load_state_dict(torch.load(os.path.join(args.output_dir, f"{args.quant_type}_{args.wbits}_reptq.pth"))) """
        lm.model.eval()
